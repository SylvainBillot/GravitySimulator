		...
		return new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				case 6:
					...
					massObjectMin.setValue(HelperVariable.MINIMALSTARMASS * 1E16);
					massObjectMax.setValue(HelperVariable.MINIMALSTARMASS * 1E18);
					matterDistribution.setValue(1);
					negligeableMass.setValue(0);
					numOfLowMassParticule.setValue(0);
					lowMassParticuleMass.setValue(1);
					...
					gasDistribution.setValue(1);
					darkMatterMass.setValue(HelperVariable.MINIMALSTARMASS * 2.5E22);
					darkMatterDensity.setValue(1E-24);
