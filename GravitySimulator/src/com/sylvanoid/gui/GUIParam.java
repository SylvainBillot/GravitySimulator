		...
		return new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				case 6:
					...
					gasViscosity.setValue(0);
					darkMatterViscosity.setValue(0.02);
					viscoElasticity.setValue(0.0001);
