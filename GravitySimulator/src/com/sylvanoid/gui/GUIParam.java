...
public class GUIParam extends JDialog {
	...
	return new ActionListener() {
		...
		case 5:
		    ...
		    lowMassParticuleMass.setValue(HelperVariable.MINIMALSTARMASS * 5E5);
		...
		case 6:
		    ...
		    manageImpact.setSelected(true);
		    timeFactor.setValue(HelperVariable.ONEYEAR * 1E7);
		    scala.setValue(1 / (7E24));
		    typeOfImpact.setSelectedIndex(1);
		    numberOfObjects.setValue(0);
		    densiteMin.setValue(2.5E-23);
		    nebulaRadius.setValue(HelperVariable.PC * 3.8E10);
		    massObjectMin.setValue(HelperVariable.MINIMALSTARMASS * 5E20);
		    massObjectMax.setValue(HelperVariable.MINIMALSTARMASS * 5E21);
		    matterDistribution.setValue(1);
		    negligeableMass.setValue(0);
		    numOfLowMassParticule.setValue(1000);
		    lowMassParticuleMass.setValue(HelperVariable.M * 7.25E22);
		    lowMassDensity.setValue(2E-23);
		    gasDistribution.setValue(1.4);
		    darkMatterMass.setValue(HelperVariable.M * 1.25E26);
		    darkMatterDensity.setValue(5E-26);
		    darkMatterDistribution.setValue(0.45);
		    ellipseRatio.setValue(0.15);
		    ellipseShiftRatio.setValue(1);
		    nbArms.setValue(3);
		    ...
		    matterViscosity.setValue(1);
		    gasViscosity.setValue(1);
		    darkMatterViscosity.setValue(0.2);
