		...
		return new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				case 6:
					...
					nebulaRadius.setValue(HelperVariable.PC * 3.5E9);
					...
					gasDistribution.setValue(1);
					darkMatterMass.setValue(HelperVariable.MINIMALSTARMASS * 7E23);
					...
					collisionDistanceRatio.setValue(1);
					matterViscosity.setValue(1E-4);
					gasViscosity.setValue(1);
					darkMatterViscosity.setValue(1E-5);
					viscoElasticity.setValue(1E-10);
					viscoElasticityNear.setValue(1E-5);
					pressureZero.setValue(0);
