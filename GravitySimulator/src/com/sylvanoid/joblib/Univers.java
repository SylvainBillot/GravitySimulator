...
public class Univers {
	...
	private List<Matter> createUnivers(Vector3d origine, Vector3d initialSpeed,
		...
		miniListMatter.addAll(createUniversMain(origine, initialSpeed,
				...
				TypeOfObject.Matter, parameters.getMatterViscosityRatio()));
		...
		miniListMatter.addAll(createUniversMain(origine, initialSpeed,
				...
				parameters.getGasViscosityRatio()));
	...
	private void createRandomRotateUnivers() {
		...
		createUniversMain(
				...
				TypeOfObject.Dark, parameters.getDarkMatterViscosityRatio());
	...
	private void createGalaxiesCollision() {
		...
		Matter m1 = new Matter(parameters, dbg2, parameters.getDarkMatterMass()
				...
				parameters.getDarkMatterViscosityRatio());
		listMatter.add(m1);
		mass += m1.getMass();
		darkMass += m1.getMass();
	...
	private void createPlanetary() {
		Matter sun = new Matter(parameters, new Vector3d(
				...
				parameters.getMatterViscosityRatio());
		sun.setName("Sun");
		listMatter.add(sun);
